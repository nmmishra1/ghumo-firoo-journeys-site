...
export default function PackageMaster() {
  ...
  const DEFAULT_PACKAGES_FALLBACK = [
    ...
    { id: 'kerala-backwaters', name: 'Kerala Backwaters & Munnar Tea Estates (6D/5N)', slug: 'kerala-backwaters', price: 22800, duration: '6 Days / 5 Nights', package_type: 'domestic', is_active: true, destinations: ['Alleppey', 'Munnar', 'Thekkady', 'Cochin'], image: 'https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?q=80&w=800' },
