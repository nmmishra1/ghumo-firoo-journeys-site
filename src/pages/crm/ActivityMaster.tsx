...
export default function ActivityMaster() {
  ...
  const filtered = activities.filter(a => {
    ...
    if (filterCountry !== 'all' && String(a.country_id) !== String(filterCountry)) return false;
    if (filterState !== 'all' && String(a.state_id) !== String(filterState)) return false;
    if (filterCity !== 'all' && String((a as any).city_id) !== String(filterCity)) return false;
